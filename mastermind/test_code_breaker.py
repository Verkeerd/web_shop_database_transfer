...
slot_amount = 4
colour_amount = 6
possible_pins = mastermind_functions.all_possible_pins(slot_amount)
...
def test_code_breaker(repeat=100):
    ...
    """
    initial_combination_list = mastermind_functions.all_possible_codes(4, 6)
    error_runs = 0
    while repeat >= 1:
        ...
        secret_code = mastermind_functions.generate_code(slots=slot_amount,
        ...
        while pins != (4, 0):
            ...
            combination_list = mastermind_functions.eliminate_codes(guess, combination_list, pins)
